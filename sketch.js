...
class Friend {
    constructor() {
        ...
        this.partStates = {
            ...
            "misc1": {index: 0, color: "#ffffff", scaleX: 0.5, scaleY: 0.5, positionX: 0.5, positionY: 0.5, rotationDegrees: 0, mirrored: false, transMin: -150, transMax: 50, dOffsetX: 0.14, dOffsetY: 0.19, allowDelete: true, partCount: 15},
